        ...
        {gameState === 'START' && (
          <motion.div key="start" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex-1 w-full flex flex-col items-center justify-center pt-8 pb-6 px-4 sm:pt-12 sm:px-12 z-10 overflow-hidden gap-12">
            ...
            <motion.button
              ...
              className="px-16 py-6 bg-[var(--robustus-orange)] text-white text-3xl font-black rounded-full shadow-[0_12px_24px_rgba(247,148,29,0.4)] border-b-8 border-[#c96f00] uppercase tracking-wider transition-all"
            >
              JOGAR
            </motion.button>
